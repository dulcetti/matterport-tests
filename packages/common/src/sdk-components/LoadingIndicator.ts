      ...
      case 'Loading':
        {
          ...
          const onEnterClip = new THREE.AnimationClip(null, onEnterTime, [
            opacityTrack,
            scaleTrack,
          ]);
          const onEnterAction: AnimationAction = this.mixer.clipAction(
            onEnterClip,
            this.inputs.logo
          );
        ...
        break;
      case 'Error':
        console.error(`Loading indicator transitioned to error state.`);
        break;
    }
  }
